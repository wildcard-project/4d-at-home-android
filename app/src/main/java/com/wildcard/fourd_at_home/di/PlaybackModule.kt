...
import com.wildcard.fourd_at_home.playback.PhoneEffectController
...
object PlaybackModule {
    ...
    @Provides
    @Singleton
    fun providePhoneEffectController(
        @ApplicationContext context: Context
    ): PhoneEffectController {
        return PhoneEffectController(context)
    }
    ...
    fun providePlaybackSyncEngine(
        ...
        phoneEffectController: PhoneEffectController
    ): PlaybackSyncEngine {
        return PlaybackSyncEngine(commandSender, phoneEffectController)
    }
}
